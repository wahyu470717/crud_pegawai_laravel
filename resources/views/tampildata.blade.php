...
@section('content')
<body>
  <h1 class="text-center mb-8 mt-2">Edit Data Pegawai</h1>
  <div class="container">
            ...
            <form action="/updatedata/{{ $data->id }}" method="POST" enctype="multipart/form-data">
              ...
              <div class="mb-4 row">
                <div class="col-3">
                  ...
                  <input type="file" name="foto" class="form-control mb-2" id="exampleInputEmail1" value="{{$data->foto}}">
                </div>
                <img src="{{ asset('fotopegawai/'.$data->foto) }}" style="max-width: 150px; max-height: 150px;" alt="image" />
              </div>
              <div class="mb-3 d-flex justify-content-end gap-2 mx-2">
